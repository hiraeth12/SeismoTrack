...
export default function TsunamiAlert({ alertTsunami }: { alertTsunami: any }) {
  function generateDiv(max: number) {
    const arrayDivs: any = [];
    const images = [
      "/images/warning_shape_yellow.svg",
      "/images/warning_shape_black.svg",
      "/images/hex_shape.svg",
    ];
    ...
    for (let i = 0; i < max; i++) {
      ...
      // Opsional: buat delay animasi acak juga
      const delay = Math.random() * 0.5; // antara 0s - 0.5s

      arrayDivs.push(
        <div key={i} style={{ animationDelay: `${delay}s` }}>
          <img src={randomImage} alt="random warning shape" />
        </div>
      );
    }
  ...
  return (
    <div
      className="fixed m-auto top-0 left-0 right-0 bottom-0 flex justify-center"
      id="tsunami-warning"
    >
      ...
      <div className="w-full flex flex-col items-center justify-center ">
        <div className="warning scale-75 md:scale-150 flex flex-col justify-center items-center">
          <div className="long-hex-tsunami flex flex-col justify-center opacity-0 show-pop-up animation-delay-1">
          ...
          <div className=" w-3/4 overflow-hidden bg-black relative rounded flex justify-center items-center opacity-0 show-pop-up animation-delay-2">
            ...
            <div className="w-full h-full p-6">
              ...
              >
                <p className="text-xs font-cascadia">
      ...
      <div className="absolute top-0 bottom-0 left-0 right-0 ">
        ...
        <div className="z-20 absolute bottom-8 left-8 md:bottom-28 md:left-28 scale-150">
          <div
            className="p-1 bg-black rounded-xl opacity-0 show-pop-up"
            style={{
              animationDelay: "2.5s",
            }}
          >
        ...
        <div className="z-20 absolute h-28 m-auto bottom-0 top-0 left-16 md:left-1/4 hidden md:block scale-150">
          <div
            className="p-1 bg-black rounded-xl opacity-0 show-pop-up del"
            style={{
              animationDelay: "2.5s",
            }}
          >
