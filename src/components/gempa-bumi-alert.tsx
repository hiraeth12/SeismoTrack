    ...
    return (!close && <div className='absolute m-auto top-0 bottom-0 left-0 right-0 flex flex-col justify-center items-center '>
        ...
        <div className='warning scale-75 md:scale-150 flex flex-col justify-center items-center '>
            <div className='long-hex flex flex-col justify-center opacity-0 show-pop-up animation-delay-1'>
                <div className="flex justify-evenly w-full items-center gap-24">
            ...
            <div className="w-full flex justify-center info">
                <div className="basic-hex -mt-12 -mr-2 opacity-0 show-pop-up flex flex-col justify-center items-center text-glow font-bold font-cascadia">
                    <p className='text-sm'>{props.magnitudo}</p>
                    <p style={{
                        fontSize: '9px',
                    }}>MAGNITUDO</p>
                </div>
                <div className="basic-hex opacity-0 show-pop-up">
                </div>
                <div className="basic-hex -mt-12 -ml-2 opacity-0 show-pop-up flex flex-col justify-center items-center text-glow font-bold font-cascadia">
                    <p className='text-sm'>{props.kedalaman}</p>
                    <p style={{
                        fontSize: '9px',
                    }}>KEDALAMAN</p>
                </div>
